...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  memoryFlow: 'personal-harness.md',
  ...
  taskRouter: 'personal-harness.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MemoryEntry: 'personal-harness.md',
  RememberMemoryInput: 'personal-harness.md',
  ...
  TaskSelection: 'personal-harness.md',
  TaskDefinition: 'personal-harness.md',
