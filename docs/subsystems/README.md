...
| [personal-harness.md](personal-harness.md) | the personal Harness composition: deterministic task routing, route-specific execution playbooks, explicit durable memory capture, and bounded task-aware recall |
